...
const API_KEY ="live_4vgETajllBoWncxqxo8g5bOBps7m7ahibDlevcNUIkLBeCoq6lWpVRTpOVjTjGME";
...
(async function initialLoad() {
  ...
  const response = await fetch(`https://api.thecatapi.com/v1/breeds?apikey=${API_KEY}`);
